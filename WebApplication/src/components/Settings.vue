            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="value">{{ totalDiskSize? totalDiskSize:$t('total_disk_size_undefined') }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <td class="value">{{ system.Version?system.Version:$t('system_version_undefined') }}</td>
                    </tr>
                    <tr>
            ...
            <table class="table">
                <tbody>
                    ...
                    :class="{'disabled-plugin': !configuration.Enabled}">
                        <th scope="row" class="w-25 header">{{ $t('plugin')}}</th>
                        <td class="w-50 value">{{ $t('configuration_description') }}</td>
                        <td class="w-15 value">{{$t('configuration_version')  }}</td>
                        <td class="w-10 value">
