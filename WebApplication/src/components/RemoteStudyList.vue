...
document._remoteStudyAllowedFilters = [
  "StudyDate",
  "StudyTime",
  "AccessionNumber",
  "PatientID",
...
export default {
  ...
  computed: {
    ...
    isFilterEmpty() {
      return (
        this.filterStudyDate.length == 0 &&
        this.filterAccessionNumber.length == 0 &&
        this.filterPatientID.length == 0 &&
        this.filterPatientName.length == 0 &&
        this.filterPatientBirthDate.length == 0 &&
        this.filterStudyDescription.length == 0 &&
        this.getModalityFilter().length == 0
      );
    },
    isStudyListEmpty() {
  ...
  methods: {
    ...
    async search() {
      ...
      if (this.remoteMode == "dicom") {
        let query = {
          // list all fields that we want to retrieve (for the RemoteStudyList and the RemoteStudyDetails)
          StudyDate: "",
          StudyTime: "",
          StudyID: "",
          AccessionNumber: "",
...
<template>
  <div>
    ...
    <div
      v-if="!isSearching && isFilterEmpty"
